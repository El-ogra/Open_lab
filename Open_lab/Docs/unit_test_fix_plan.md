...
| 3 | حذف ودمج 20 نسخة مكررة | ✅ مكتملة |
| 4 | إصلاح المخالفة المعمارية (نقل فئات ViewModel) | ✅ مكتملة |
| 5 | إضافة تعليق // Function: X.X للـ 418 اختبار | ✅ مكتملة |
| 6 | إكمال بنية AAA للـ 417 اختبار | ✅ مكتملة |
| 7 | إعادة تسمية 28 اختباراً مخالفاً | ✅ مكتملة |
| 8A | إضافة اختبارات VM للوظائف الجزئية الآمنة | ✅ مكتملة |
