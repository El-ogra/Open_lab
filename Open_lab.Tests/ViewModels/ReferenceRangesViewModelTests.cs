    ...
    public class ReferenceRangesViewModelTests : IDisposable
    {
        ...
        public void SelectedRange_Setter_Should_Load_Data()
        {
            ...
            var range = new TestReferenceRange
            {
                ...
                AgeFromDays = 1 * AgeConverter.DaysPerYear,
                AgeToValue = 12,
                AgeToUnit = AgeConverter.UnitYear,
                AgeToDays = 12 * AgeConverter.DaysPerYear,
                LowValue = 5,
                HighValue = 8,
                NormalText = "Normal"
            };
            ...
            _viewModel.AgeFromValue.Should().Be(1);
            _viewModel.AgeToValue.Should().Be(12);
